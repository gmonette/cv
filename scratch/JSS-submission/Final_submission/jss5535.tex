...
{\centering \subfloat[\label{fig:mpg-horsepower-polynomials-1}]{\includegraphics[width=0.45\linewidth]{Figures/mpg-horsepower-polynomials-1} }~~~\subfloat[\label{fig:mpg-horsepower-polynomials-2}]{\includegraphics[width=0.45\linewidth]{Figures/mpg-horsepower-polynomials-2} }
...
polynomial \(p\) ranging from 1 (a linear regression) to 10.\footnote{Although
  ...
  \code{plot(mpg $\sim$ horsepower, data=Auto, log="xy")} (execution of
  which is left to the reader). We revisit the \code{Auto} data in
...
{\centering \subfloat[\label{fig:polynomial-regression-CV-graph-2-1}]{\includegraphics[width=0.5\linewidth]{Figures/polynomial-regression-CV-graph-2-1} }~~~\subfloat[\label{fig:polynomial-regression-CV-graph-2-2}]{\includegraphics[width=0.5\linewidth]{Figures/polynomial-regression-CV-graph-2-2} }
...
list \code{mlist}. We then used \code{cv()} to compare the
