...
* \code{data}, which can usually be inferred from the \code{model} object, using the \code{get_data()` function from the \pkg{insight} package [@LudeckeWaggonerMakowski:2019]. The \pkg{insight} package provides a robust way to access model components for many classes of statistical models.
