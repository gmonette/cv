...
We've compressed this material, primarily by removing the scatterplot matrix and C+R plots for the transformed data. We'd prefer not to abbreviate the section further: The purpose of the section is to show how to automate a complex model-selection method, so we think that it's important to explain how the method is applied "manually" before automating it.
...
Yes, the predictors are transformed individually with the object of making their joint distribution as close to multinormal as possible. We have clarified this point in the resubmssion.
