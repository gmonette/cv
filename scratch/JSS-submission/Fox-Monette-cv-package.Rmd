...
```
The response variable in this example, \code{Attrition}, is binary. The function \code{holdout_results()} must be supplied by the user, and "\code{accuracy}" is the complement of the Bayes-rule classification error rate.
