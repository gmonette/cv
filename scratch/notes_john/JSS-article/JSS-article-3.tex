...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 486347
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.52274
bias-adjusted cross-validation criterion = 19.49438
95% CI for bias-adjusted CV criterion = (15.96188, 23.02687)
