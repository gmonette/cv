...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 423102
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.27853
bias-adjusted cross-validation criterion = 19.26291
95% CI for bias-adjusted CV criterion = (15.80408, 22.72175)
