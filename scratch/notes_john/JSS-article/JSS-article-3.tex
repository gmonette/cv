...
\code{cv()} function also can cross-validate complex model-selection
...
correct \(k\)-fold CV for bias (see Section
...
{\centering \subfloat[\label{fig:mpg-horsepower-polynomials-1}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/mpg-horsepower-polynomials-1} }\subfloat[\label{fig:mpg-horsepower-polynomials-2}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/mpg-horsepower-polynomials-2} }

}

\caption{(a) \code{mpg} vs. \code{horsepower} for the \code{Auto} data, showing fitted polynomials of degree 1 through 5. (b) Estimated squared error as a function of polynomial degree, $p$.}\label{fig:mpg-horsepower-polynomials}
\end{figure}
\end{CodeChunk}
...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 180983
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.37365
bias-adjusted cross-validation criterion = 19.35319
95% CI for bias-adjusted CV criterion = (15.87805, 22.82834)
...
Unit: microseconds
 ...
 hatvalues    996.956   1181.292   1496.971   1216.777   1233.157   4243.664
  Woodbury  12189.054  12270.726  13187.437  12580.645  12664.121  16369.455
     naive 216220.101 218010.571 231464.303 220980.816 223550.942 280828.393
    cv.glm 381634.027 383670.456 404475.689 390533.979 441471.559 442930.011
 neval
    10
    10
    10
...
\begin{CodeInput}
R> # 10-fold CV
R> mlist <- models(mlist) # create "modList" object
R> 
...
invoke the \code{plot()} method for the \code{"cvModList"} object
...
{\centering \subfloat[\label{fig:polynomial-regression-CV-graph-2-1}]{\includegraphics[width=0.5\linewidth]{JSS-article-3_files/figure-latex/polynomial-regression-CV-graph-2-1} }\subfloat[\label{fig:polynomial-regression-CV-graph-2-2}]{\includegraphics[width=0.5\linewidth]{JSS-article-3_files/figure-latex/polynomial-regression-CV-graph-2-2} }
...
Model failed to converge with max|grad| = 0.00587131 (tol = 0.002, component 1)
\end{CodeOutput}
\begin{CodeOutput}
...
{\centering \subfloat[\label{fig:plot1-1}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/plot1-1} }\subfloat[\label{fig:plot1-2}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/plot1-2} }\newline\subfloat[\label{fig:plot1-3}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/plot1-3} }\subfloat[\label{fig:plot1-4}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/plot1-4} }\newline\subfloat[\label{fig:plot1-5}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/plot1-5} }
...
{\centering \subfloat[\label{fig:cross-validation-clusters-1}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/cross-validation-clusters-1} }\subfloat[\label{fig:cross-validation-clusters-2}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/cross-validation-clusters-2} }
...
{\centering \subfloat[\label{fig:Auto-explore-1}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/Auto-explore-1} }\subfloat[\label{fig:Auto-explore-2}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/Auto-explore-2} }

}

\caption{(a) Scatterplot matrix for the numeric variables in the \code{Auto} data. In each panel, the solid line shows the linear least-squares fit and the broken line is for a nonparametric regression. (b) Component+residual plots for the working model fit to the \code{Auto} data. The broken blue lines show linear least-squares fits, while the solid magenta lines are nonparametric-regression smooths.}\label{fig:Auto-explore}
\end{figure}
\end{CodeChunk}
...
{\centering \subfloat[\label{fig:Auto-transformed-scatterplot-matrix-1}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/Auto-transformed-scatterplot-matrix-1} }\subfloat[\label{fig:Auto-transformed-scatterplot-matrix-2}]{\includegraphics[width=0.45\linewidth]{JSS-article-3_files/figure-latex/Auto-transformed-scatterplot-matrix-2} }

}

\caption{(a) Scatterplot matrix for the transformed numeric variables in the \code{Auto} data. (b) Component+residual plots for the working model fit to the transformed \code{Auto} data.}\label{fig:Auto-transformed-scatterplot-matrix}
\end{figure}
\end{CodeChunk}
...
data\footnote{What we call here ``recursive CV'' has also been termed
  ...
  \citet{BatesHastieTibshirani:2023}.}}{Example: Applying recursive CV to polynomial regression for the Auto data}}\label{example-applying-recursive-cv-to-polynomial-regression-for-the-auto-data9}
...
\end{CodeOutput}
\begin{CodeInput}
R> # reports complement of Bayes-rule criterion:
R> train(x = attrition[, c("JobSatisfaction", "Gender",
+                                "MonthlyIncome")],
...
Unit: milliseconds
      ...
      rsample 5892.991705 5997.040644 6197.075663 6180.82761 6298.898798
        caret 6863.187210 6952.637853 7008.026442 7024.60940 7072.257280
       direct 5483.414538 5488.340073 5603.901283 5564.68712 5655.604370
     cv.exact 4829.717139 4885.941915 5049.808394 5021.14425 5155.600842
      cv.wood  104.694812  110.656458  114.844686  117.06384  119.173552
 cv.hatvalues    1.281824    1.513761    1.656785    1.59406    1.668454
         max neval
 6871.248999    10
 7095.635316    10
 5972.080828    10
...
\code{method="exact"}, but more than an order of magnitude slower than
\code{cv()} with \code{method="Woodbury"}, and more than three orders of
magnitude slower then \code{cv()} with \code{method="hatvalues"}.
