...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 969978
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.18252
bias-adjusted cross-validation criterion = 19.17193
95% CI for bias-adjusted CV criterion = (15.72359, 22.62027)
