...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 799417
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.20609
bias-adjusted cross-validation criterion = 19.19442
95% CI for bias-adjusted CV criterion = (15.73743, 22.6514)
