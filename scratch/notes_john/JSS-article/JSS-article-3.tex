...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 716237
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.28027
bias-adjusted cross-validation criterion = 19.2646
95% CI for bias-adjusted CV criterion = (15.81196, 22.71725)
...
Unit: microseconds
 ...
 hatvalues    984.369   1182.604   1188.963   1202.345   1220.242   1293.468
  Woodbury  12366.543  12508.690  13408.099  12769.347  12815.124  16566.050
     naive 216467.126 217748.581 225187.170 219534.685 222515.077 276207.898
    cv.glm 373527.917 380937.683 393430.301 382341.584 389266.341 443234.190
 neval
    10
    10
    10
...
\pkg{modeldata} package \citep{Kuhn:2024} (and which is by a wide margin
the most downloaded from the RStudio CRAN mirror of the CV packages
mentioned in the preceding paragraph). Here, with minimal explanation,
is how one would perform LOO CV for this example using
\pkg{rsample}:\footnote{The example in the \pkg{rsample} vignette uses
...
Let's compare the computational efficiency of the three implementations,
...
Unit: milliseconds
      ...
      rsample 5707.408772 5711.011032 5810.464433 5828.739437 5853.64979
       direct 5187.215696 5206.152940 5281.503347 5230.005408 5348.24496
     cv.exact 4659.560948 4691.022749 4735.789317 4737.251540 4790.76759
      cv.wood   99.232628  104.541882  106.917914  106.051051  108.49436
 cv.hatvalues    1.187401    1.224875    2.751965    1.356813    1.56374
        max neval
 5999.09487    10
 5500.60457    10
 4811.15176    10
...
Computing time for \pkg{rsample} for this problem is similar to direct
computation of LOO CV and to \code{cv()} with \code{method="exact"}, but
more than an order of magnitude slower than \code{cv()} with
\code{method="Woodbury"}, and more than three orders of magnitude slower
then \code{cv()} with \code{method="hatvalues"}.
