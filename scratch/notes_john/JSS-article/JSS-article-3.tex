...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 507470
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.41715
bias-adjusted cross-validation criterion = 19.39447
95% CI for bias-adjusted CV criterion = (15.86881, 22.92014)
...
The \pkg{caret} package doesn't directly support generalized linear
models fit by \code{glm()}, but it can be made to do so by defining a
custom ``method'' for the binary logistic regression fit to the
\code{attrition} data:
...
R> 
R> glm_mod <- getModelInfo("glm", regex = FALSE)[[1]]
R> glm_mod$fit <- function(x, y, wts, param, lev, last, classProbs, ...) {
+   x$Attrition <- y
+   glm(Attrition ~ JobSatisfaction + Gender + MonthlyIncome,
+       family = binomial, data = x)
+ }
R> 
R> mod <- train(x = attrition[, c("JobSatisfaction", "Gender",
+                                "MonthlyIncome")],
+              y = attrition$Attrition,
+              method = glm_mod,
+              trControl = trainControl(method="LOOCV"))
R> mod # reports complement of Bayes-rule criterion
\end{CodeInput}
\begin{CodeOutput}
...
In fairness, \pkg{caret} really isn't intended for this kind of simple
CV computation.
...
Unit: milliseconds
      ...
      rsample 5853.035606 5948.291603 6163.101903 6121.042951 6144.223100
        caret 6804.763276 6951.219335 7097.717763 7061.439656 7255.566640
       direct 5310.127259 5350.848336 5554.513023 5484.144809 5690.480487
     cv.exact 4751.498733 4797.980556 4879.481352 4870.303039 4927.941413
      cv.wood  101.606159  103.891294  108.285899  108.577430  112.075263
 cv.hatvalues    1.206999    1.471613    1.514548    1.554679    1.614416
         max neval
 6981.899881    10
 7541.571242    10
 6081.412412    10
