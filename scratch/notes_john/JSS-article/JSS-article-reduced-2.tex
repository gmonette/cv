...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 352413
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.42674
bias-adjusted cross-validation criterion = 19.40347
95% CI for bias-adjusted CV criterion = (15.89518, 22.91177)
