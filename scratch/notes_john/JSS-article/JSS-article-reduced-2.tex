...
\end{CodeInput}
\begin{CodeOutput}
R RNG seed set to 801552
\end{CodeOutput}
\begin{CodeOutput}
10-Fold Cross Validation
method: Woodbury
criterion: mse
cross-validation criterion = 19.32751
bias-adjusted cross-validation criterion = 19.30935
95% CI for bias-adjusted CV criterion = (15.83674, 22.78196)
...
\hypertarget{example-cv-of-clusters-versus-individuals-using-contrived-data}{%
\subsection{Example: CV of clusters versus individuals using contrived
data}\label{example-cv-of-clusters-versus-individuals-using-contrived-data}}
...
\item
  ...
  \code{model} (\code{m.auto}) for predictor selection, the names of the
  variables---\code{predictors} and \code{response}---that are
  candidates for transformation, and \code{AIC=FALSE}, which specifies
