...
```
For this scheme to work, the "casewise loss" attribute must be a character string, here `"(y - yhat)^2"`, that evaluates to an expression that is a function of `y` and `yhat`, and that computes the vector of casewise components of the CV criterion.
