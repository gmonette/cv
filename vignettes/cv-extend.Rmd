...
* `blups` and `fixed.effects` are used to compute detailed fold-based statistics for case-based and cluster-based CV, respectively.
...
## Appendix: Why the complement of AUC isn't a casewise CV criterion
