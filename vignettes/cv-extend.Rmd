...
* `fun` is the mixed-modeling function used to fit the model, here  `nlme::lme`; `cvMixed()` uses this argument to infer the package namespace in which the modeling function lives.
