...
The data for the examples in this section are drawn from the **ISLR2** package for R, associated with @JamesEtAl:2013 
...
### Logistic regression for the `Caravan` data
